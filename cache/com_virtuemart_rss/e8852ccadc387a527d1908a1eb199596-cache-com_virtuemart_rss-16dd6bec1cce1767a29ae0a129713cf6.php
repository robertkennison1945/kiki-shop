...
</ul>";}i:2;O:8:"stdClass":3:{s:4:"link";s:62:"http://virtuemart.net/news/486-virtuemart-3-2-8-bugfix-release";s:5:"title";s:33:"VirtueMart 3.2.8 - Bugfix Release";s:11:"description";s:2813:"<p>Unfortunately, we were a bit too fast with our security release, having found an error in the testing phase we created another small bug while we were fixing it.</p>
...
</ul>";}i:3;O:8:"stdClass":3:{s:4:"link";s:94:"http://virtuemart.net/news/482-virtuemart-3-2-6-security-release-and-overhauled-infrastructure";s:5:"title";s:65:"VirtueMart 3.2.6 - Security Release and overhauled infrastructure";s:11:"description";s:4455:"<p>A minor XSS vulnerability was present in versions prior to 3.2.6. It occurred when the features feeds and search were used together. It happened only for feed enabled, so administrators can also close the leak in earlier versions by disabling the feed functions. The URL creation of the feed function used an improper call for JRoute. So urlencoded js was executed. The problem is fixed now by using our getCurrentUrlBy function, which works with a whitelist for variable names and it urlencodes any value.&nbsp;</p>
<div>
<p><a href="http://virtuemart.net/download">DOWNLOAD VM3 NOW<br> VirtueMart 3 component (core and AIO)</a></p>
</div>
...
<p>You can find the full list of changes here:&nbsp;http://forum.virtuemart.net/index.php?topic=138912.0</p>
