...
<div class="info_pane table">
<h2><?php echo JText::_('STARTER_DESCR_1'),' Custom Filters <b>Starter</b> edition!'?></h2>
<p><?php echo JText::_('STARTER_DESCR_2')?></p>
<p><?php echo JText::_('STARTER_DESCR_3')?>
<a href="https://breakdesigns.net/extensions/custom-filters" target="_blank">Custom Filters</a>
