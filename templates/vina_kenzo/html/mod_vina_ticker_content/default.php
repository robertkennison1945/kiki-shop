					...
					<div class="span<?php echo (!empty($image) && $showImage) ? 8 : 12; ?>">
						<div class="text-block">
							...
							<div class="info">
								...
								<span class="date"><em><?php echo JTEXT::_('VINA_PUBLISHED'); ?>:</em> <?php echo JHTML::_('date', $created, 'F d, Y');?></span>
								<?php endif; ?>
								
								<?php if($showCategory) : ?>
								<span class="cat"><em><?php echo JTEXT::_('VINA_CATEGORY'); ?>:</em> <?php echo $category; ?></span>
								<?php endif; ?>
								
								<?php if($showHits) : ?>
								<span class="hits"><em><?php echo JTEXT::_('VINA_HITS'); ?>:</em> <?php echo $hits; ?></span>
								<?php endif; ?>
							</div>
							<?php endif; ?>
