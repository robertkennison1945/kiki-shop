...
?>
	...
	<div class="social-sharing">
		<span class="title-sharing"><?php echo JText::_('LANG_SOCIAL_SHARE'); ?></span>
		<a href="http://www.facebook.com/sharer.php?u=<?php echo $this->item->readmore_link;?>" class="social_facebook jutooltip" title="Share Facebook" target="_blank"><i class="fa fa-facebook"></i></a>
		<a href="http://twitter.com/share?url=<?php echo $this->item->readmore_link;?>" class="social_twitter jutooltip" title="Share Twitter" target="_blank"><i class="fa fa-twitter"></i></a>
		<!-- Google +1 Button -->
		<a href="https://plus.google.com/share?url=<?php echo $this->item->readmore_link;?>"  class="social_google jutooltip" title="Share Google Plus" target="_blank"><i class="fa fa-google-plus"></i></a>
	</div>
