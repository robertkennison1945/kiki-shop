...
<head>
    ...
    $this->helix3->addCSS('bootstrap.min.css, font-awesome.min.css, lightslider.min.css, uniform.default.css, owl.theme.css, owl.carousel.css') // CSS Files
        ->addJS('bootstrap.min.js, jquery.sticky.js, main.js, bootstrap-select.min.js, owl.carousel.js, jquery.uniform-modified.js, template.js') // JS Files
